    ...
    <body>
        <header class="container">
            <div class="row py-4">
                <div class="col-sm-11 col-md-10 col-lg-9 col-xl-8 col-xxl-7 mx-auto">
                    ...
                    <h2 class="mb-5 text-center fs-6 text-black-50">POR <a href="#" class="link-secondary">MANUELA MUNCHMEYER</a></h2>
            ...
            <div class="row">
                <div class="col-sm-11 col-md-10 col-lg-9 col-xl-8 col-xxl-7 mx-auto">
                    ...
                    <div class="w-75 my-3 mx-auto">
                        <object type="image/svg+xml" data="img/gojira.svg" class="w-100">ゴジラ</object>
                    </div>
        ...
        <section class="container my-5">
            <div class="row">
                ...
                <div class="col-xl-11 col-xxl-10 mx-auto">
                    <object type="image/svg+xml" data="img/pangolin_phone.svg" class="w-100 d-md-none">Reseña o imagen alternativa</object>
                    <object type="image/svg+xml" data="img/pangolin_facts.svg" class="w-100 d-none d-md-block">Reseña o imagen alternativa</object>
                </div>
            </div>
        </section>
        ...
        <div class="bg-black text-white">
            <section class="container py-5">
                <div class="row">
                    <div class="col-sm-11 col-md-10 col-lg-9 col-xl-8 col-xxl-7 mx-auto">
                        ...
                        <object type="image/svg+xml" data="img/problems-m.svg" class="w-100 d-md-none">Reseña o imagen alternativa</object>
                        <object type="image/svg+xml" data="img/problems.svg" class="w-100 d-none d-md-block">Reseña o imagen alternativa</object>
                    </div>
                </div>
            </section>
            ...
            <aside class="container">
                <div class="row">
                    <div class="col-sm-11 col-md-10 col-lg-9 col-xl-8 col-xxl-7 mx-auto">
                        <p>La ingenieria inversa sirve para entender la complejidad e inteligencia de la programación que existe detrás de una página que busca transmitir información de la manera más simple y fluida, para que sea intuitiva y llamativa finalmente para el lector del artículo. </p>
                    </div>
                </div>
            </aside>
